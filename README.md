...
- [Quick Start — راهنمای استفاده سریع](#-quick-start---راهنمای-استفاده-سریع)
...
---
## 🚀 Quick Start — راهنمای استفاده سریع
...
### انجام‌شده ✅
- [x] 기본적인 DoH proxy implementation and local VPN-based DNS interception (core functionality already implemented and available in releases).
...
Users are responsible for complying with applicable laws and regulations. The developers assume no liability for misuse of this application.
